...
<div class="text-darkblue lg:p-0 lg:mt-8 lg:mb-8 mx-auto max-w-screen-lg bg-extremegray">
	...
	<div class="px-8 py-4 mx-auto lg:w-5/6">
		<p class="text-justify pb-4">
			...
			görünüşü ve dijital saatlerin sayıları gösterme işlevini bir araya getirerek Hybart serisi
			saatlerinin Kadınlar ve Erkekler için olan iki farklı modelini ortaya çıkardı.
		</p>
		<p class="text-justify">
			Qloque diğer saat markalarından ayrışarak yenilikçi bir konsept oluşturdu. Bu yeni konsept
			saatlerde yelkovan ve saniye ibresi bulunmuyor. Yelkovan ve saniye ibresi yerine dakikayı ve
			saniyeyi sayısal olarak gösteren sayaçlar bulunuyor. Marka bu konsept ile hem her anı değerli
			olan insanın zamanı tam olarak bilme ihtiyacını karşılıyor hem de günlük hayatın
			koşuşturmacasında insanların Qloque saatleriyle her zaman şık kalmasını sağlıyor.
		</p>
	</div>
	<div class="py-4 mx-auto">
	...
	<div class="px-8 mx-auto lg:w-5/6">
		...
		<p class="py-4 text-justify">
			...
			saat başı Qloque saatlerinden çıkan ses insanları harekete geçirmek için bir uyarı
			niteliğindedir. Saatlerin sesli bildirim özelliği, gün boyunca zamanın farkında olunmasına ve
	...
	<div class="px-8 mx-auto lg:w-5/6">
		...
		<p class="py-4 italic text-justify">
			...
			markasıdır. Qloque, saat endüstrisinde Türkiye’de üretim yapan ilk ve tek yerli markadır.
			Qloque, benzersiz tasarımlara sahip kuvars mekanizmalı klasik saatler üretmektedir. İlk
			mağazasını İstanbul, Nişantaşı’nda açan marka; bugün İzmir, Ankara ve Antalya’da birer tane
			olmak üzere toplam dört mağazayla Türkiye’de hizmet vermektedir.
		</p>
	</div>
...
<div class="text-darkblue lg:p-0 lg:mt-8 lg:mb-8 mx-auto max-w-screen-lg bg-extremegray">
	...
	<div class="px-8 py-4 mx-auto lg:w-5/6">
		<p class="text-justify pb-4">
			...
			güç olarak anlattığım Zoom reklam filmini hayata geçirdim.
		</p>
	</div>
</div>
